...
const icu_extended_cfg_t g_external_irq1_ext_cfg = { .filter_src =
		EXTERNAL_IRQ_DIGITAL_FILTER_PCLK_DIV, };

const external_irq_cfg_t g_external_irq1_cfg = { .channel = 0, .trigger =
...
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = (void*) &g_external_irq1_ext_cfg, .ipl = (12),
