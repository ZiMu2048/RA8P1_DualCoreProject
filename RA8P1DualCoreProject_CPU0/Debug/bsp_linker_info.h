...
#define BSP_PARTITION_FLASH_CPU0_S_SIZE (0xD8000)
#define BSP_PARTITION_FLASH_CPU0_C_START (0x020D8000)
#define BSP_PARTITION_FLASH_CPU0_C_SIZE (0x0)
#define BSP_PARTITION_FLASH_CPU1_S_START (0x020D8000)
#define BSP_PARTITION_FLASH_CPU1_S_SIZE (0x28000)
...
#define BSP_PARTITION_SDRAM_CPU0_S_SIZE (0x7E00000)
#define BSP_PARTITION_SDRAM_CPU1_S_START (0x6FE00000)
#define BSP_PARTITION_SDRAM_CPU1_S_SIZE (0x1E0000)
#define BSP_PARTITION_SHAREMEM_START (0x6FFE0000)
#define BSP_PARTITION_SHAREMEM_SIZE (0x20000)
